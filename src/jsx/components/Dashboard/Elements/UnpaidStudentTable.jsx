...
const tableData = [
    { id: '1', image: trans1, name: 'Jordan Nico', studid: 'ID 1234567911', class: 'XII A', fee: '52.03', rank: 'First' },
    { id: '2', image: trans2, name: 'Karen Hope', studid: 'ID 1234567101', class: 'XI B', fee: '45.50', rank: 'Second' },
    { id: '3', image: trans3, name: 'Nadila Adja', studid: 'ID 1234567001', class: 'VII C', fee: '25.10', rank: 'Third' },
    { id: '4', image: trans4, name: 'James Brown', studid: 'ID 1234567231', class: 'VI A', fee: '10.00', rank: 'First' },
    { id: '5', image: trans5, name: 'Dack Xarma', studid: 'ID 1234567456', class: 'XII B', fee: '23.50', rank: 'Second' },
    { id: '9', image: trans4, name: 'James Brown', studid: 'ID 1234567231', class: 'VI A', fee: '10.00', rank: 'First' },
    { id: '10', image: trans5, name: 'Dack Xarma', studid: 'ID 1234567456', class: 'XII B', fee: '23.50', rank: 'Second' },
    { id: '6', image: trans1, name: 'Jordan Nico', studid: 'ID 1234567911', class: 'XII A', fee: '52.03', rank: 'First' },
    { id: '7', image: trans2, name: 'Karen Hope', studid: 'ID 1234567101', class: 'XI B', fee: '45.50', rank: 'Second' },
    { id: '8', image: trans3, name: 'Nadila Adja', studid: 'ID 1234567001', class: 'VII C', fee: '25.10', rank: 'Third' },
];
