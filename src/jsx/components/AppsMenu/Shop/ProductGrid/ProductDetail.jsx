	...
	return (
		<>
			...
			<div className="row">
									...
									<div className="product-detail-content">
										...
										<div className="new-arrival-content pr">
											...
											<div className="comment-review star-rating d-flex">
												...
												<Link onClick={() => dispatch({ type: 'reviewToggle' })} className="product-review" to="/ecom-product-detail" data-toggle="modal" data-target="#reviewModal">Write a review?</Link>
											</div>
											<div className="d-table mb-2">
												<p className="price float-left d-block">$325.00</p>
											</div>
											<p> <span className="item fs-14"> Availability:{" "} </span> {" "}In stock <i className="fa fa-shopping-basket" /> </p>
											<p> <span className="item fs-14">Product code: </span> 0405689 {" "}</p>
											<p><span className="item fs-14">Brand: </span>Lee</p>
											<p>
												<span className="item fs-14">Product tags:&nbsp;&nbsp;</span>
												<span className="badge badge-warning light me-1">bags</span>
												<span className="badge badge-success light me-1">clothes</span>
												<span className="badge badge-info light me-1">shoes</span>
												<span className="badge badge-danger light me-1">dresses</span>
											</p>
				...
				{/* review */}
				<Modal show={state.reviewToggle} onHide={() => dispatch({ type: 'reviewToggle' })} className="modal fade" id="reviewModal">
					<>
