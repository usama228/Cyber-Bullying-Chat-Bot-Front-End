												...
												<div className="my-post-content pt-3">
													...
													<div className="profile-uoloaded-post border-bottom-1 pb-5">
														...
														<Link className="post-title" to="/post-details">
															<h3 className="text-black">How To Get (A) Fabulous EDUCATION On A Tight Budget</h3>
														</Link>
														<p>
													...
													<div className="profile-uoloaded-post border-bottom-1 pb-5">
														...
														<Link className="post-title" to="/post-details">
															<h3 className="text-black">How To Win Clients And Influence Markets with EDUCATION</h3>
														</Link>
														<p>
													...
													<div className="profile-uoloaded-post pb-3">
														<img src={profile08} alt="" className="img-fluid  w-100 rounded" />
														<Link className="post-title" to="/post-details">
															<h3 className="text-black">What Can Instagramm Teach You About EDUCATION</h3>
														</Link>
														<p>
															A wonderful serenity has take possession of my
															entire soul like these sweet morning of spare which
			...
			<Modal show={state.post} className="modal fade" id="postModal" onHide={() => dispatch({ type: 'postModal' })} centered>
				<div className="modal-content">
					<div className="modal-header">
						...
						<Button variant="" type="button" className="close lineheight1" onClick={() => dispatch({ type: 'postModal' })} >
							<span>×</span>
						</Button>
