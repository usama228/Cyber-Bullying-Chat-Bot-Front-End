...
const tableData = [
    { id: '1', image: IMAGES.trans1, name: 'Samantha William', tabid: '123456789', date: 'March 25, 2023', parentname: 'Mana William', city: 'Jakarta', grade: 'VII A' },
    { id: '2', image: IMAGES.trans2, name: 'Tony Soap', tabid: '123453254', date: 'June 25, 2023', parentname: 'James Soap', city: 'Phoenix', grade: 'XII A' },
    { id: '3', image: IMAGES.trans3, name: 'Karen Hope', tabid: '123456452', date: 'July 25, 2023', parentname: 'Justin Hope', city: 'Texas', grade: 'IX A' },
    { id: '4', image: IMAGES.trans4, name: 'Jordan Nico', tabid: '123442584', date: 'Apr 25, 2023', parentname: 'Amanda Nico', city: 'Dallas', grade: 'VII A' },
    { id: '5', image: IMAGES.trans5, name: 'Nadila Adja', tabid: '654781357', date: 'May 25, 2023', parentname: 'Jack Adja', city: 'Houston', grade: 'XII A' },
    { id: '6', image: IMAGES.trans6, name: 'Johnny Ahmad', tabid: '123454555', date: 'Feb 25, 2023', parentname: 'Miranda Adila', city: 'Chicago', grade: 'XII A' },
    { id: '7', image: IMAGES.trans7, name: 'Dakota Farral', tabid: '235456789', date: 'Jan 25, 2023', parentname: 'Maria Historia', city: 'Philadelphia', grade: 'IX  A' },
    { id: '8', image: IMAGES.trans8, name: 'Dimitres Viga', tabid: '568756789', date: 'March 25, 2023', parentname: 'James Soap', city: 'Sharjah', grade: 'VII A' },
    { id: '9', image: IMAGES.trans9, name: 'Samantha William', tabid: '999956789', date: 'July 25, 2023', parentname: 'Mana William', city: 'Ajman', grade: 'IX A' },
    { id: '10', image: IMAGES.trans5, name: 'Samantha William', tabid: '882356789', date: 'Aug 25, 2023', parentname: 'Jack Adja', city: 'Umm', grade: 'XII A' },
    { id: '11', image: IMAGES.trans2, name: 'Samantha William', tabid: '123456789', date: 'March 25, 2023', parentname: 'Mana William', city: 'Jakarta', grade: 'VII A' },
    { id: '12', image: IMAGES.trans1, name: 'Tony Soap', tabid: '123453254', date: 'June 25, 2023', parentname: 'James Soap', city: 'Phoenix', grade: 'XII A' },
    { id: '13', image: IMAGES.trans5, name: 'Karen Hope', tabid: '123456452', date: 'July 25, 2023', parentname: 'Justin Hope', city: 'Texas', grade: 'IX A' },
    { id: '14', image: IMAGES.trans3, name: 'Jordan Nico', tabid: '123442584', date: 'Apr 25, 2023', parentname: 'Amanda Nico', city: 'Dallas', grade: 'VII A' },
    { id: '15', image: IMAGES.trans5, name: 'Nadila Adja', tabid: '654781357', date: 'May 25, 2023', parentname: 'Jack Adja', city: 'Houston', grade: 'XII A' },
    { id: '16', image: IMAGES.trans6, name: 'Johnny Ahmad', tabid: '123454555', date: 'Feb 25, 2023', parentname: 'Miranda Adila', city: 'Chicago', grade: 'XII A' },
    { id: '17', image: IMAGES.trans7, name: 'Dakota Farral', tabid: '235456789', date: 'Jan 25, 2023', parentname: 'Maria Historia', city: 'Philadelphia', grade: 'IX A' },
    { id: '18', image: IMAGES.trans8, name: 'Dimitres Viga', tabid: '568756789', date: 'March 25, 2023', parentname: 'James Soap', city: 'Sharjah', grade: 'VII A' },
    { id: '19', image: IMAGES.trans9, name: 'Samantha William', tabid: '999956789', date: 'July 25, 2023', parentname: 'Mana William', city: 'Ajman', grade: 'IX A' },
    { id: '20', image: IMAGES.trans1, name: 'Samantha William', tabid: '882356789', date: 'Aug 25, 2023', parentname: 'Jack Adja', city: 'Umm', grade: 'XII A' },
    { id: '15', image: IMAGES.trans9, name: 'Samantha William', tabid: '999956789', date: 'July 25, 2023', parentname: 'Mana William', city: 'Ajman', grade: 'IX A' },
    { id: '16', image: IMAGES.trans5, name: 'Samantha William', tabid: '882356789', date: 'Aug 25, 2023', parentname: 'Jack Adja', city: 'Umm', grade: 'XII A' },
    { id: '17', image: IMAGES.trans2, name: 'Samantha William', tabid: '123456789', date: 'March 25, 2023', parentname: 'Mana William', city: 'Jakarta', grade: 'VII A' },
    { id: '18', image: IMAGES.trans1, name: 'Tony Soap', tabid: '123453254', date: 'June 25, 2023', parentname: 'James Soap', city: 'Phoenix', grade: 'XII A' },
                                        ...
                                        <tbody>
                                            {records.map((item, ind) => (
                                                <tr key={ind}>
                                                    ...
                                                    <td><span className="text-primary font-w600">ID {item.tabid}</span></td>
                                                    <td>
                                                    ...
                                                    <td>
                                                        <div className={`badge bg-${item.grade === 'VII A' ? 'secondary' : item.grade === 'XII A' ? 'primary' : 'warning'}`}>
                                                            {item.grade}
                                                        </div>
                                                    </td>
                                                    <td>
