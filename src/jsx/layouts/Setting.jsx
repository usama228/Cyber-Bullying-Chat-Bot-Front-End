		...
		<>
			<div className={`sidebar-right ${settingToggle ? "show" : ""}`}>
				...
				<div className="sidebar-right-inner">
					...
					<div className="note-text"><span className="text-danger">*Note :</span> This theme switcher is not part of product. It is only for demo. you will get all guideline in documentation. please check <a href="https://akademi.dexignlab.com/react/doc" target="_blank" className="text-primary">documentation.</a></div>
				</div>
			</div>
			...
			<div className={`dlab-demo-panel ${demoToggle ? "show" : ""}`}>
				...
				<div className="dlab-demo-inner">
					...
					<div className="dlab-demo-content dlab-scroll">
						<div className="dlab-wrapper ">
							<div className="overlay-bx dlab-demo-bx demo-active">
								...
								<div className="overlay-layer">
									<Link to={"#"} onClick={() => setDemoTheme(1, 'ltr')} data-theme="1" className="btn dlab_theme_demo btn-secondary btn-sm mr-2">Default</Link>
								</div>
							</div>
